...
export function Selector({
  ...
  return (
    <div className={panelClass || DEFAULT_PANEL_CLASS}>
      <button type="button" onClick={onPrev} disabled={disablePrev} className="h-11 w-11 rounded-lg theme-hover flex items-center justify-center shrink-0 disabled:opacity-30 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-400/80" aria-label={ariaLabelPrev}><ChevronLeft className="h-4 w-4 text-white/80" /></button>
