...
const DEFAULT_MESSAGES: Messages = {
  ...
  booking: {
    ...
    cvc_placeholder: 'CVC',
    error_rib_required: 'Add your RIB in Settings before switching to Online mode.',
  ...
  profile_add_card: {
    ...
    holder_name_placeholder: 'IVAN IVANOV',
  },
  profile_delete: {
  ...
  settings: {
    ...
    rib_details: 'RIB details',
    rib_label: 'RIB / IBAN',
    rib_placeholder: 'Enter your RIB / IBAN',
    rib_attach: 'Attach RIB file',
    remove: 'Remove',
