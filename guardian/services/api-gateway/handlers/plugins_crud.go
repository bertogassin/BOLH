	...
	templates := []gin.H{
		{
			"id":          "daily_report",
			"name":        "Daily report",
			"description": "Automatic shift report generation with photo and signature",
			"icon":        "doc.text.fill",
			"category":    "Reports",
		...
		{
			"id":          "contract",
			"name":        "Contract in a minute",
			"description": "Template-based contract generator for clients",
		...
		},
		{
			"id":          "branding",
			"name":        "Brand style",
			"description": "Brand all documents with company logo",
		...
		},
		{
			...
			"description": "Create and print receipts for clients",
			"icon":        "receipt.fill",
			"category":    "Finance",
